...
var IAB = {
    ...
    injectScriptFile: function (win, fail, args) {
        var msg = 'Browser cordova-plugin-inappbrowser4wx injectScriptFile is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
    ...
    injectStyleCode: function (win, fail, args) {
        var msg = 'Browser cordova-plugin-inappbrowser4wx injectStyleCode is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
    ...
    injectStyleFile: function (win, fail, args) {
        var msg = 'Browser cordova-plugin-inappbrowser4wx injectStyleFile is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
